@domain:basic_ops @m2 @REQ-API_BASIC-042 @spec(api_basic_operations.md#513-open-error-conditions)
Feature: Open error conditions

  @REQ-API_BASIC-042 @error
  Scenario: Open returns validation error for non-existent file
  ...
  @REQ-API_BASIC-042 @error
  Scenario: Open returns validation error for invalid path
    Given a Package instance
  ...
  @REQ-API_BASIC-042 @error
  Scenario: Open returns validation error for invalid package format
    Given a Package instance
  ...
  @REQ-API_BASIC-042 @error
  Scenario: Open returns I/O error on file system errors
    Given a Package instance
  ...
  @REQ-API_BASIC-042 @error
  Scenario: Open returns security error for insufficient permissions
    Given a Package instance
  ...
  @REQ-API_BASIC-042 @error
  Scenario: Open returns context error on cancellation
    Given a Package instance
  ...
  @REQ-API_BASIC-042 @error
  Scenario: Open returns context error on timeout
    Given a Package instance
