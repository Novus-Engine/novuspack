@domain:file_mgmt @m2 @REQ-FILEMGMT-033 @spec(api_file_mgmt_compression.md#7-file-compression-operations) @spec(api_file_mgmt_file_entry.md#7-file-compression-operations)
