...
func RegisterFileMgmtPatterns(ctx *godog.ScenarioContext) {
	...
	ctx.Step(`^a file with magic number not equal to NVPKMagic$`, aFileWithMagicNumberNotEqualToNVPKMagic)
	...
	// all tags are returned - registered in file_tags.go
	// all tags are set - registered in file_tags.go
	...
	// "a file entry with primary path" - registered in file_format/file_entry.go
...
func aFileWithMagicNumberNotEqualToNVPKMagic(ctx context.Context) error {
	// TODO: Create a file with magic number not equal to NVPKMagic
	return godog.ErrPending
}
...
// allTagsAreReturned is implemented in file_tags.go
// func allTagsAreReturned(ctx context.Context) error {
// 	// TODO: Verify all tags are returned
// 	return godog.ErrPending
// }

// allTagsAreSet is implemented in file_tags.go
...
// aFileEntryWithoutSpecificTag is implemented in file_tags.go
...
// aFileEntryWithTags is implemented in file_tags.go
