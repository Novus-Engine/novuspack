...
import (
	...
	compressionsteps "github.com/novus-engine/novuspack/api/go/v1/_bdd/steps/compression"
	coresteps "github.com/novus-engine/novuspack/api/go/v1/_bdd/steps/core"
	fileformatsteps "github.com/novus-engine/novuspack/api/go/v1/_bdd/steps/file_format"
	filemgmtsteps "github.com/novus-engine/novuspack/api/go/v1/_bdd/steps/file_mgmt"
	// stepspkg "github.com/novus-engine/novuspack/api/go/v1/_bdd/steps" // Commented out - all step files backed up, will be reorganized
)
...
func InitializeScenario(ctx *godog.ScenarioContext) {
	...
	// stepspkg.RegisterWritingSteps(ctx)                      // Backed up - to be reorganized
