...
const (
	// NPKMagic is the magic number identifying a NovusPack file ("NVPK")
...
// Specification: ../../docs/tech_specs/package_file_format.md Section 4.1.1.3 - Compression and Encryption Types
const (
...
// Specification: ../../docs/tech_specs/package_file_format.md Section 4.1.5 - Hash Algorithm Support
const (
...
// Specification: ../../docs/tech_specs/package_file_format.md Section 2.5.1 - Flags Field Encoding
const (
...
// Specification: ../../docs/tech_specs/package_file_format.md Section 2.3.1 - VendorID Example Mappings
const (
